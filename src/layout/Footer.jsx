...
const Footer = () => {
    return (
        <footer className="footer gray-bg text-sm">
            <div className="container spacer-y">
                <div className="footer-row">
                    <div className="footer-col">
                        <img src="./images/sj-logo-w.png" className="footer-logo mb-3" alt="" />
                        <ul className="list-unstyled m-0 footer-cont">
                            <li className="cont-list">
                                <div className="cont-icon">
                                    <img src={addressIcon} alt="" />
                                </div>
                                <div className="cont-text">
                                    9 Lawrence Ln Bay Shore, New York, USA
                                </div>
                            </li>
                            <li className="cont-list">
                                <div className="cont-icon">
                                ...
                                <div className="cont-text">
                                    <a href="tel:343-565-6756" className="d-block">343-565-6756</a>
                                    <a href="tel:232-878-76575" className="d-block">232-878-76575</a>
                                </div>
                            </li>
                            <li className="cont-list mb-0">
                                <div className="cont-icon">
                                    <img src={mailIcon} alt="" />
                                </div>
                                <div className="cont-text">
                                    <a href="mailto:sarenajewerly@gmail.com" className="d-block">sarenajewerly@gmail.com</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div className="footer-col">
                        ...
                        <ul className="list-unstyled m-0 footer-list">
                    ...
                    <div className="footer-col">
                        ...
                        <ul className="list-unstyled m-0 footer-list">
                            ...
                            <li><a href="./privacy-cookie.html">Privacy & Cookie Policy</a></li>
                        </ul>
                    </div>
                    <div className="footer-col">
                        <h5 className="mb-3">Social Media</h5>
                        <ul className="list-unstyled m-0 footer-socials">
                            <li>
                                <a href="#">
                            ...
                            <li>
                                <a href="#">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_6011_61512)">
                                            <path
                            ...
                            <li>
                                <a href="#">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_6011_61514)">
                                            <path
            ...
            <div className="copyright">
                <div className="container">
                    <div className="row g-3 gy-lg-0 align-items-center">
                        <div className="col-lg-6 col-md-6">
                            <p className="text-center text-md-start">Copyright &copy; <span className="year"></span> <a
                                href="#">sarenajewerly</a>. All Rights Reserved.</p>
                        </div>
                        <div className="col-lg-6 col-md-6">
                            <ul className="list-unstyled m-0 payment-icons">
                                ...
                                <li><img src="./images/icons/ame-exp.svg" alt="" /></li>
